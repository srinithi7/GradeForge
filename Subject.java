...
public class Subject implements Serializable {
    ...
    public Subject(String subjectCode, String subjectName, int creditHours,
            double ca1Marks, double ca2Marks, double targetGrade,
    ...
    public double calculateInternalAverage() {
        internalAverage = (ca1Marks + ca2Marks) / 2.0;
        return internalAverage;
    }

    public double calculateExternalRequired() {
        double targetTotal = 0;
        if (targetGrade == 10) targetTotal = 91;
        else if (targetGrade == 9) targetTotal = 81;
        else if (targetGrade == 8) targetTotal = 71;
        else if (targetGrade == 7) targetTotal = 61;
        else if (targetGrade == 6) targetTotal = 50;
        
        externalRequired = targetTotal - internalAverage;
        if (externalRequired < 0) externalRequired = 0;
        if (externalRequired > 75) externalRequired = 75;
    ...
    public String toString() {
        return subjectCode + " — " + subjectName + "\n" +
               ...
               "CA1: " + ca1Marks + " | CA2: " + ca2Marks + "\n" +
               "Internal Avg: " + internalAverage + "\n" +
               "External Needed: " + externalRequired + "/75\n" +
